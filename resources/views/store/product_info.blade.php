        ...
        <div class="container">
            <div class="contenus bg-light">
                ...
                <div class="form-group m-5">
                    ...
                    <input type="text" class="form-control" name="shippingCost" style="@error('shippingCost') border:1px solid red; @enderror" placeholder="Shipping cost" value="{{$product->shippingCost}}">
                </div>
                @error('shippingCost')
                <div style="color: red; text-align: center;">{{ $message }}</div>
                @enderror
